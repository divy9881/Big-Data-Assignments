...
$ $SPARK_HOME/bin/spark-submit --master=spark://10.10.1.1:7077 ./Big-Data-Assignments/Assignment\ 1/Part-3/enwiki-articles/Task-1/pagerank.py hdfs://10.10.1.1:9000/part-3/enwiki/*
```